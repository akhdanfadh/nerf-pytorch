"""
nerf_synthetic.py - Abstraction of 'nerf_synthetic' dataset.
"""
...
from ..utils import load_blender_data


class NeRFSyntheticDataset(data.Dataset):
    """
    Dataset object for loading 'nerf_synthetic' dataset.
    """
    ...
    def __init__(
        ...
        """
        Constructor of 'NeRFSyntheticDataset'.
        """
        # check arguments
